...
class HybridLearner(ActiveLearner):
    ...
    def get_per_element_score(self, candidate_text_elements: Sequence[TextElement],
        ...
        scores1 = self.active_learner1.get_per_element_score(candidate_text_elements, candidate_text_element_predictions, workspace_id, model_id, dataset_name, category_name)
        scores2 = self.active_learner2.get_per_element_score(candidate_text_elements, candidate_text_element_predictions, workspace_id, model_id, dataset_name, category_name)
