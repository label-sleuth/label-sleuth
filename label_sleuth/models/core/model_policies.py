...
class ModelPolicies:
    ...
    STATIC_MULTICLASS_FLANT5XL_MPT = StaticModelPolicy(ModelsCatalog.MULTICLASS_FLANT5XL_MPT)
    STATIC_BINARY_FLANT5XL_MPT = StaticModelPolicy(ModelsCatalog.BINARY_FLANT5XL_MPT)
